...
def get_chps_individual_data(
    ...
    Args:
        characteristic (str): Options are 'ethnicity', 'lac' or 'eng'.
    ...
    df = download_obj(
        S3_BUCKET,
        f"scotland/data/chps_aggregated/processed/{characteristic}_developmental_breakdown.csv",
